...
app.commandLine.appendSwitch('disable-features', 'UserActivationClientV2')
app.commandLine.appendSwitch('disable-features', 'MediaRouter')
app.commandLine.appendSwitch('disable-features', 'DialMediaRouteProvider')
app.commandLine.appendSwitch('disable-features', 'CastMediaRouteProvider')
...
app.commandLine.appendSwitch('disable-features', 'WebHID')
app.commandLine.appendSwitch('disable-features', 'WebSerial')
app.commandLine.appendSwitch('disable-features', 'WebXR')
app.commandLine.appendSwitch('disable-features', 'WebGPU')
app.commandLine.appendSwitch('disable-features', 'WebCodecs')
app.commandLine.appendSwitch('disable-features', 'ReportingAPI')
app.commandLine.appendSwitch('disable-features', 'IdleDetection')
app.commandLine.appendSwitch('disable-features', 'InterestFeedContentSuggestions')
app.commandLine.appendSwitch('disable-features', 'NavigationPredictor')
app.commandLine.appendSwitch('disable-features', 'PageInfoAboutThisSite')
app.commandLine.appendSwitch('disable-features', 'PrivacySandboxAdsAPIs')
app.commandLine.appendSwitch('disable-features', 'PrivacySandboxAudienceMeasurement')
app.commandLine.appendSwitch('disable-features', 'PrivacySandboxTopicsAPI')
app.commandLine.appendSwitch('disable-features', 'PrivacySandboxFledge')
app.commandLine.appendSwitch('disable-features', 'FingerprintingEntropyReduction')
...
app.commandLine.appendSwitch('disable-features', 'UserMediaScreenCapturing')
...
app.commandLine.appendSwitch('disable-software-rasterizer')
app.commandLine.appendSwitch('disable-direct3d11')
app.commandLine.appendSwitch('disable-direct3d9')
