export default {
  key: {
    ...
    mute: '静音',
    desktopLyrics: '词',
    desktopLyricsEnabled: '桌面歌词已开启',
    desktopLyricsDisabled: '桌面歌词已关闭',
    playModeList: '列表循环',
    playModeSingle: '单曲循环',
    playModeRandom: '随机播放',
    playModeOff: '不循环',
    ...
    // --- 异常与调试 ---
    emptyMusic: '音乐数据为空',
    musicInPlaylist: '音乐已在播放列表中',
    invalidMusicList: '无效的音乐列表',
    musicExistsSkip: '音乐已存在，跳过',
    downloadMusicFailedSkipCache: '下载音乐失败，跳过缓存',
    getFilePathFailedSkipCache: '获取文件路径失败，跳过缓存',
